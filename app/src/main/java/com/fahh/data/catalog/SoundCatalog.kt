...
object SoundCatalog {
    ...
    val sounds: List<Sound> = listOf(
        ...
        Sound("Wasted", R.raw.gta_v_wasted, "G", isLocked = true, packName = "Gamer", id = "gta_wasted"),
        Sound("Cina", R.raw.his_name_is_john_cena, "J", isLocked = true, packName = "Classic", id = "john_cena"),
        Sound("Hurt", R.raw.minecraft_hurt, "M", isLocked = true, packName = "Gamer", id = "minecraft_hurt"),
        Sound("Money", R.raw.money, "M", isLocked = true, packName = "Reaction", id = "money"),
        Sound("Oof", R.raw.roblox_oof, "R", isLocked = true, packName = "Gamer", id = "roblox_oof"),
        ...
        Sound("Taker", R.raw.the_undertaker_bell, "U", isLocked = true, packName = "Classic", id = "undertaker_bell"),
